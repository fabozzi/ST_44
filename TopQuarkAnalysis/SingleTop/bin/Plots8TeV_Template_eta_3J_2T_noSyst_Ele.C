...
// Postscript options:                                                                                                                                       
  ...
  TString folder = "../afs/cern.ch/work/f/ffienga/8TeV";
  TString folder = "8TeV";
...
//postfix_file = "";
 ...
 // TString cut = "weight*(808.47+4428.0+7021.24+7039.0 )*0.98*bWeight*PUWeight";
  ...
  TString cutW = "*(1.0/PUWeight)";
  TString cutW = "*(1.0)";
  TString MCCut = "";
  TString cutData = "1."; 
  
TString cutIso="*1";
//TString cutIso="*(leptonRhoCorrectedRelIso<0.04)";
...
//  TLatex * tex = new TLatex(0.205, 0.97,"CMS Preliminary, 19.3 fb^{-1}, Electrons"+stringCharge+", #sqrt{s} = 8 TeV");
  ...
  tex->Draw();	
TString histoname = oTitle+TString("_")+channel+sample+TString("")+lepton;  TH1D * ALLMC =  new TH1D( histoname, histoname,nBins,observableMin,observableMax);  ALLMC->Add(TChannel);ALLMC->Add(TTBar);ALLMC->Add(WJets);ALLMC->Add(SChannel);ALLMC->Add(TWChannel);ALLMC->Add(WJets);ALLMC->Add(ZJets);ALLMC->Add(WW);ALLMC->Add(QCDEle);cout<< "ks test "<< ALLMC->KolmogorovTest(Data)<<" chi2 "<< ALLMC->Chi2Test(Data) <<endl;

  cout << "test <<<<<" <<endl;
     //C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_DDNorm_IsoLess0p04_"+oTitle+"_EleStack_nqcd.root");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_DDNorm_IsoLess0p04_"+oTitle+"_EleStack_nqcd.png");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_DDNorm_IsoLess0p04_"+oTitle+"_EleStack_nqcd.pdf");
  // C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_DDNorm_IsoLess0p04"+"_"+oTitle+"_NormtoData_EleStack_nqcd.root");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+ "_DDNorm_IsoLess0p04"+"_"+oTitle+"_NormtoData_EleStack_nqcd.png");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+ "_DDNorm_IsoLess0p04"+ "_"+oTitle+ "_NormtoData_EleStack_nqcd.pdf");
         C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_"+oTitle+"_EleStack_nqcd.root");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_"+oTitle+"_EleStack_nqcd.png");   C3.SaveAs("noteTTBDT/plots_nqcd/"+sample+"_"+oTitle+"_EleStack_nqcd.pdf"); 
}
