...
// Postscript options:                                                                                                                                       
  ...
  */
  ...
  //  if ((inputsample == "2J_1T") || (inputsample == "3J_2T") || (inputsample == "2J_0T"))
  //    sample = "noSyst";

  //  if (inputsample == "3J_2T")
  //    sample = sample + "3J2T";

  //  if (inputsample == "2J_0T") {
  //    sample = sample + "WSample";
  //    sampleqcd = "noSystWSampleQCD";
  //  }
  //  if (inputsample == "2J_1T")
  //    sampleqcd = "noSystQCD";
  ...
  channel = "WJets";
  filename = (folder + "/"+channel+""+postfix_file+".root");
  //  filename = (folder + "/"+channel+""+postfix_file+"_inclusive.root");
  f = TFile::Open(filename);
  if( !f->IsOpen() ){
    cout<< " WARNING FILE " << filename << endl;
    continue;
  ...
  cout << mupath <<endl;
  cout << elepath <<endl;
  cout << observable << nBins << observableMin << observableMax <<endl;
  cout << cutDataQCD <<endl;
  TH1D * tmp  = new TH1D("t","t",nBins,observableMin,observableMax);
